"use strict";
(self["webpackChunkreact_redux_arcgis_boilerplate"] = self["webpackChunkreact_redux_arcgis_boilerplate"] || []).push([["vendors-node_modules_arcgis_core_views_2d_engine_webgl_mesh_MeshData_js-node_modules_arcgis_c-01a17c"],{
...
/* harmony export */   createLabelFunction: function() { return /* binding */ w; },
/* harmony export */   formatField: function() { return /* binding */ g; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   callExpressionWithCursor: function() { return /* binding */ r; },
/* harmony export */   callExpressionWithCursorWithDefault: function() { return /* binding */ t; },
/* harmony export */   isBadArcadeResult: function() { return /* binding */ n; }
/* harmony export */ });
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
function r(r,n,t){if(null==r)return null;const u=n.readArcadeFeature();n.contextTimeZone=t.$view?.timeZone;try{return r.evaluate({...t,$feature:u},r.services)}catch(a){return _core_Logger_js__WEBPACK_IMPORTED_MODULE_1__["default"].getLogger("esri.views.2d.support.arcadeOnDemand").warn("Feature arcade evaluation failed:",a),null}}function n(e){return null==e||e===1/0||e===-1/0||"number"==typeof e&&isNaN(e)}function t(e,r,t,u){if(null==e)return null!=u?u:null;const a=r.readArcadeFeature();r.contextTimeZone=t.$view?.timeZone;const o=e.evaluate({...t,$feature:a},e.services);return n(o)?null!=u?u:null:o}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   MeshData: function() { return /* binding */ n; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   VertexDataWriter: function() { return /* binding */ r; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ResourceProxy: function() { return /* binding */ s; }
/* harmony export */ });
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
class s extends _shaderGraph_techniques_mesh_AResourceProxy_js__WEBPACK_IMPORTED_MODULE_2__.AResourceProxy{constructor(e){super(),this._fetcher=e,this._controller=new AbortController,this._pendingIds=new Set,this._pendingRequests=[],this._resourceIdToResource=new Map}destroy(){this._controller.abort()}get _abortOptions(){return{signal:this._controller.signal}}enqueueRequest(r){const s=(0,_Utils_js__WEBPACK_IMPORTED_MODULE_1__.discardUrlIfHasUrlHash)(r.resource),o=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_0__.numericHash)(JSON.stringify(s));return this._pendingIds.has(o)||(this._pendingIds.add(o),this._pendingRequests.push({...r,resourceId:o})),o}async fetchEnqueuedResources(){const e=this._pendingRequests;this._pendingIds.clear(),this._pendingRequests=[];const t=await this._fetcher.fetch(e,this._abortOptions);for(let r=0;r<t.length;r++){const s=e[r].resourceId;this._resourceIdToResource.set(s,t[r])}}async fetchResourceImmediate(e){const t=await this._fetcher.fetch([e],this._abortOptions);if(1!==t.length)throw new Error("FeaturePipelineResourceProxy: failed to fetch resources");return t[0]}async fetchDictionaryResourceImmediate(e){const t=await this._fetcher.fetchDictionary([e],this._abortOptions);if(1!==t.length)throw new Error("FeaturePipelineResourceProxy: failed to fetch dictionary resources");return t[0]}getResource(e){return this._resourceIdToResource.get(e)}}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AResourceProxy: function() { return /* binding */ s; }
/* harmony export */ });
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DEBUG_ATTR_UPDATES: function() { return /* binding */ l; },
/* harmony export */   createDebugLogger: function() { return /* binding */ n; }
/* harmony export */ });
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FeatureStoreQueryAdapter: function() { return /* binding */ t; }
/* harmony export */ });
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
class t{getObjectId(t){return t.getObjectId()}getAttributes(t){return t.readAttributes()}getAttribute(t,e){return t.readAttribute(e)}getAttributeAsTimestamp(t,e){return t.readAttributeAsTimestamp(e)}cloneWithGeometry(t,e){return t}getGeometry(t){return t.readGeometryWorldSpace()}getCentroid(t,e){return t.readCentroidForDisplay()}}t.Shared=new t;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AComputedField: function() { return /* binding */ s; }
/* harmony export */ });
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AttributeStore: function() { return /* binding */ b; },
/* harmony export */   getVisualVariableSizeValueRepresentationRatio: function() { return /* binding */ g; }
/* harmony export */ });
/* harmony import */ var _core_Error_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../core/Error.js */ "./node_modules/@arcgis/core/core/Error.js");
...
/* harmony import */ var _engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../engine/webgl/DisplayId.js */ "./node_modules/@arcgis/core/views/2d/engine/webgl/DisplayId.js");
/* harmony import */ var _engine_webgl_Utils_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../engine/webgl/Utils.js */ "./node_modules/@arcgis/core/views/2d/engine/webgl/Utils.js");
/* harmony import */ var _engine_webgl_shaderGraph_techniques_shaders_constants_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../engine/webgl/shaderGraph/techniques/shaders/constants.js */ "./node_modules/@arcgis/core/views/2d/engine/webgl/shaderGraph/techniques/shaders/constants.js");
/* harmony import */ var _engine_webgl_util_debug_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../engine/webgl/util/debug.js */ "./node_modules/@arcgis/core/views/2d/engine/webgl/util/debug.js");
/* harmony import */ var _DisplayIdGenerator_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./DisplayIdGenerator.js */ "./node_modules/@arcgis/core/views/2d/layers/features/support/DisplayIdGenerator.js");
/* harmony import */ var _FeatureFilter_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./FeatureFilter.js */ "./node_modules/@arcgis/core/views/2d/layers/features/support/FeatureFilter.js");
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
function g(t,e){if(!t||!e)return t;switch(e){case"radius":case"distance":return 2*t;case"diameter":case"width":return t;case"area":return Math.sqrt(t)}return t}const _=()=>_core_Logger_js__WEBPACK_IMPORTED_MODULE_2__["default"].getLogger("esri.views.layers.2d.features.support.AttributeStore"),f=(0,_engine_webgl_util_debug_js__WEBPACK_IMPORTED_MODULE_8__.createDebugLogger)(_engine_webgl_util_debug_js__WEBPACK_IMPORTED_MODULE_8__.DEBUG_ATTR_UPDATES,_()),y={sharedArrayBuffer:(0,_core_has_js__WEBPACK_IMPORTED_MODULE_1__["default"])("esri-shared-array-buffer"),atomics:(0,_core_has_js__WEBPACK_IMPORTED_MODULE_1__["default"])("esri-atomics")};class m{constructor(t,e,i){this.size=0,this.texelSize=4,this.dirtyStart=0,this.dirtyEnd=0;const{pixelType:s,layout:r,textureOnly:n}=e;this.textureOnly=n||!1,this.pixelType=s,this.layout=r,this._resetRange(),this.size=t,this.isLocal=i,n||(this.data=this._initData(s,t))}get buffer(){return this.data?.buffer}unsetComponentAllTexels(t,e){const i=this.data;for(let s=0;s<this.size*this.size;s++)i[s*this.texelSize+t]&=~e;this.dirtyStart=0,this.dirtyEnd=this.size*this.size-1}setComponentAllTexels(t,e){const i=this.data;for(let s=0;s<this.size*this.size;s++)i[s*this.texelSize+t]|=255&e;this.dirtyStart=0,this.dirtyEnd=this.size*this.size-1}setComponent(t,e,i){const s=this.data;for(const r of i)s[r*this.texelSize+t]|=e,this.dirtyStart=Math.min(this.dirtyStart,r),this.dirtyEnd=Math.max(this.dirtyEnd,r)}setComponentTexel(t,e,i){this.data[i*this.texelSize+t]|=e,this.dirtyStart=Math.min(this.dirtyStart,i),this.dirtyEnd=Math.max(this.dirtyEnd,i)}unsetComponentTexel(t,e,i){this.data[i*this.texelSize+t]&=~e,this.dirtyStart=Math.min(this.dirtyStart,i),this.dirtyEnd=Math.max(this.dirtyEnd,i)}getData(t,e){const i=(0,_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_5__.getDisplayIdTexel)(t);return this.data[i*this.texelSize+e]}setData(t,e,i){const s=(0,_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_5__.getDisplayIdTexel)(t),r=1<<e;this.layout&r?null!=this.data&&(this.data[s*this.texelSize+e]=i,this.dirtyStart=Math.min(this.dirtyStart,s),this.dirtyEnd=Math.max(this.dirtyEnd,s)):_().error("mapview-attributes-store","Tried to set a value for a texel's readonly component")}expand(t){if(this.size=t,!this.textureOnly){const e=this._initData(this.pixelType,t),i=this.data;e.set(i),this.data=e}}toMessage(){const t=this.dirtyStart,e=this.dirtyEnd,i=this.texelSize;if(t>e)return null;this._resetRange();const s=!this.isLocal,r=this.pixelType,n=this.layout,a=this.data;return{start:t,end:e,data:s&&a.slice(t*i,(e+1)*i)||null,pixelType:r,layout:n}}_initData(t,e){const i=ArrayBuffer,s=(0,_engine_webgl_Utils_js__WEBPACK_IMPORTED_MODULE_6__.getPixelArrayCtor)(t),r=new s(new i(e*e*4*s.BYTES_PER_ELEMENT));for(let n=0;n<r.length;n+=4)r[n+1]=255;return r}_resetRange(){this.dirtyStart=2147483647,this.dirtyEnd=0}}class b{constructor(t){this._client=t,this._filters=[],this._blocks=new Array,this._attributeComputeInfo=null,this._abortController=new AbortController,this._size=_engine_webgl_definitions_js__WEBPACK_IMPORTED_MODULE_4__.attributeStoreInitialSize,this._idsToHighlight=new Map,this._referencesScale=!1,this._referencesGeometry=!1,this._initialized=!1,this.version=0,this._idGenerator=new _DisplayIdGenerator_js__WEBPACK_IMPORTED_MODULE_9__.DisplayIdGenerator,this._epoch=1}destroy(){this._abortController.abort()}_initialize(){if(null!=this._blockDescriptors)return;const t=_webgl_enums_js__WEBPACK_IMPORTED_MODULE_11__.PixelType.FLOAT;f(`Creating AttributeStore ${y.sharedArrayBuffer?"with":"without"} shared memory`),this._blockDescriptors=[{pixelType:_webgl_enums_js__WEBPACK_IMPORTED_MODULE_11__.PixelType.UNSIGNED_BYTE,layout:1},{pixelType:_webgl_enums_js__WEBPACK_IMPORTED_MODULE_11__.PixelType.UNSIGNED_BYTE,layout:15,textureOnly:!0},{pixelType:_webgl_enums_js__WEBPACK_IMPORTED_MODULE_11__.PixelType.UNSIGNED_BYTE,layout:15,textureOnly:!0},{pixelType:t,layout:15},{pixelType:t,layout:15},{pixelType:t,layout:15},{pixelType:t,layout:15},{pixelType:_webgl_enums_js__WEBPACK_IMPORTED_MODULE_11__.PixelType.FLOAT,layout:15}],this._blocks=this._blockDescriptors.map((()=>null))}get referencesScale(){return this._referencesScale}get referencesGeometry(){return this._referencesGeometry}get hasHighlight(){return this._idsToHighlight.size>0}createDisplayIdForObjectId(t){return this._idGenerator.createIdForObjectId(t)}releaseDisplayIdForObjectId(t){return this._idGenerator.releaseIdForObjectId(t)}incrementDisplayIdGeneration(){this._idGenerator.incrementGeneration()}releaseAllIds(){this._idGenerator.releaseAll()}async update(t,e,s,r,n=0){const a=(0,_core_accessorSupport_diffUtils_js__WEBPACK_IMPORTED_MODULE_3__.diff)(this._schema,t);if(this.version=n,a&&((0,_core_has_js__WEBPACK_IMPORTED_MODULE_1__["default"])("esri-2d-update-debug")&&console.debug(`Version[${n}] AttributeStore.update`,{changed:a}),this._schema=t,this._attributeComputeInfo=null,this._initialize(),null!=t))if(s&&(this._filters=await Promise.all(t.filters.map((t=>t?_FeatureFilter_js__WEBPACK_IMPORTED_MODULE_10__["default"].create({geometryType:s.geometryType,hasM:!1,hasZ:!1,timeInfo:s.timeInfo,fieldsIndex:s.fieldsIndex,spatialReference:r??s.spatialReference,filterJSON:t}):null)))),"subtype"!==t.type)this._attributeComputeInfo={isSubtype:!1,map:new Map},await Promise.all(t.bindings.map((async t=>{const i=await this._bind(e,t);this._referencesGeometry=this._referencesGeometry||(i?.referencesGeometry()??!1),this._referencesScale=this._referencesScale||(i?.referencesScale()??!1)})));else{this._attributeComputeInfo={isSubtype:!0,subtypeField:t.subtypeField,map:new Map},this._referencesScale=!1,this._referencesGeometry=!1;for(const i in t.bindings){const s=t.bindings[i];await Promise.all(s.map((async t=>{const s=await this._bind(e,t,parseInt(i,10));this._referencesGeometry=this._referencesGeometry||(s?.referencesGeometry()??!1),this._referencesScale=this._referencesScale||(s?.referencesScale()??!1)})))}}}setHighlight(t,e){const i=this._getBlock(0);i.unsetComponentAllTexels(0,(1<<_engine_webgl_definitions_js__WEBPACK_IMPORTED_MODULE_4__.maxHighlightReasons)-1);for(const{displayId:s,highlightFlags:r}of t){if(null==s)continue;const t=(0,_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_5__.getDisplayIdTexel)(s);i.setComponent(0,r,[t])}this._idsToHighlight.clear();for(const{objectId:s,highlightFlags:r}of t)this._idsToHighlight.set(s,r);for(const{objectId:s,highlightFlags:r}of e)this._idsToHighlight.set(s,r)}setData(t,e,i,s){const r=(0,_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_5__.getDisplayIdTexel)(t);this._ensureSizeForTexel(r),this._getBlock(e).setData(t,i,s)}getData(t,e,i){return this._getBlock(e).getData(t,i)}getHighlightFlags(t){return this._idsToHighlight.get(t)||0}unsetAttributeData(t){const e=(0,_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_5__.getDisplayIdTexel)(t);this._getBlock(0).setData(e,0,0)}setAttributeData(t,e,i){const s=(0,_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_5__.getDisplayIdTexel)(t);this._ensureSizeForTexel(s),this._getBlock(0).setData(s,0,this.getFilterFlags(e));const r=this._attributeComputeInfo,o=1,h=4;let c=null;r&&(c=r.isSubtype?r.map.get(e.readAttribute(r.subtypeField)):r.map,c?.size&&c.forEach(((t,r)=>{const a=r*o%h,c=Math.floor(r*o/h),d=this._getBlock(c+_engine_webgl_definitions_js__WEBPACK_IMPORTED_MODULE_4__.AttributeDataType.VV);let u=t.field?.read(e,i);t.valueRepresentation&&(u=g(u,t.valueRepresentation));(null===u||isNaN(u)||u===1/0||u===-1/0)&&(u=_engine_webgl_shaderGraph_techniques_shaders_constants_js__WEBPACK_IMPORTED_MODULE_7__.nanMagicNumber),d.setData(s,a,u)})))}get epoch(){return this._epoch}sendUpdates(){const t=this._blocks.map((t=>null!=t?t.toMessage():null)),e=this._getInitArgs();(0,_core_has_js__WEBPACK_IMPORTED_MODULE_1__["default"])("esri-2d-log-updating")&&console.log("AttributeStore: _doSendUpdate.start"),this._client.update({initArgs:e,blockData:t,version:this.version,sendUpdateEpoch:this._epoch}),this._epoch+=1,(0,_core_has_js__WEBPACK_IMPORTED_MODULE_1__["default"])("esri-2d-log-updating")&&console.log("AttributeStore: _doSendUpdate.end")}_ensureSizeForTexel(t){for(;t>=this._size*this._size;)if(this._expand())return}async _bind(t,e,i){const s=await t.createComputedField(e),{valueRepresentation:r}=e,n=this._attributeComputeInfo;if(n.isSubtype){const t=n.map.get(i)??new Map;t.set(e.binding,{field:s,valueRepresentation:r}),n.map.set(i,t)}else n.map.set(e.binding,{field:s,valueRepresentation:r});return s}_getInitArgs(){return this._initialized?null:(this._initialized=!0,this._getBlock(_engine_webgl_definitions_js__WEBPACK_IMPORTED_MODULE_4__.AttributeDataType.Animation),this._getBlock(_engine_webgl_definitions_js__WEBPACK_IMPORTED_MODULE_4__.AttributeDataType.GPGPU),this._getBlock(_engine_webgl_definitions_js__WEBPACK_IMPORTED_MODULE_4__.AttributeDataType.LocalTimeOrigin),{blockSize:this._size,blockDescriptors:this._blocks.map((t=>null!=t?{textureOnly:t.textureOnly,buffer:t.buffer,pixelType:t.pixelType}:null))})}_getBlock(t){const e=this._blocks[t];if(null!=e)return e;f(`Initializing AttributeBlock at index ${t}`);const i=new m(this._size,this._blockDescriptors[t],this._client.isLocal);return this._blocks[t]=i,this._initialized=!1,i}_expand(){if(this._size<this._schema.capabilities.maxTextureSize){const t=this._size<<=1;f("Expanding block size to",t,this._blocks);for(const e of this._blocks)e?.expand(t);return this._initialized=!1,this._size=t,0}return _().error(new _core_Error_js__WEBPACK_IMPORTED_MODULE_0__["default"]("mapview-limitations","Maximum number of onscreen features exceeded.")),-1}isVisible(t){return!!(this._getBlock(0).getData(t,0)&1<<_engine_webgl_definitions_js__WEBPACK_IMPORTED_MODULE_4__.maxHighlightReasons)}getFilterFlags(t){let e=0;for(let s=0;s<this._filters.length;s++){const i=!!(1<<s),r=this._filters[s];e|=(!i||null==r||r.check(t)?1:0)<<s}let i=0;if(this._idsToHighlight.size){const e=t.getObjectId();i=this.getHighlightFlags(e)}return e<<_engine_webgl_definitions_js__WEBPACK_IMPORTED_MODULE_4__.maxHighlightReasons|i}}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   CachedField: function() { return /* binding */ r; }
/* harmony export */ });
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
class r extends _AComputedField_js__WEBPACK_IMPORTED_MODULE_0__.AComputedField{constructor(e){super(),this._field=e}resize(e){throw new Error("Method not implemented.")}read(e,r){return e.readAttribute(this._field)}readWithDefault(e,r){return e.readAttribute(this._field)}referencesScale(){return!1}referencesGeometry(){return!1}}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ComputedAttributeStorage: function() { return /* binding */ p; }
/* harmony export */ });
/* harmony import */ var _core_Error_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../core/Error.js */ "./node_modules/@arcgis/core/core/Error.js");
/* harmony import */ var _core_Logger_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../core/Logger.js */ "./node_modules/@arcgis/core/core/Logger.js");
...
/* harmony import */ var _NormalizedField_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./NormalizedField.js */ "./node_modules/@arcgis/core/views/2d/layers/features/support/NormalizedField.js");
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
const a=()=>_core_Logger_js__WEBPACK_IMPORTED_MODULE_1__["default"].getLogger("esri.views.2d.layers.features.support.ComputedAttributeStorage"),c=4294967295;function m(t,e,s){if(!(t.length>e))for(;t.length<=e;)t.push(s)}class p{constructor(t){this._numerics=[],this._strings=[],this._allocatedSize=256,this._bitsets=[],this._instanceIds=[],this._bounds=[],this._dirtyBitset=this.getBitset(this.createBitset()),this.compilationOptions=t}createBitset(){const t=this._bitsets.length;return this._bitsets.push(_StaticBitSet_js__WEBPACK_IMPORTED_MODULE_8__.StaticBitSet.create(this._allocatedSize,_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask)),t+1}async createComputedField(e,s=!1){if(e.expression)try{if(!this.compilationOptions)throw new Error("InternalError: Compilation options not defined");if(s)return await _ComputedLegacyLabelExpression_js__WEBPACK_IMPORTED_MODULE_6__.ComputedLegacyLabelExpression.create(e.expression,this.compilationOptions);return await _ComputedExpression_js__WEBPACK_IMPORTED_MODULE_5__.ComputedExpression.create(e.expression,this.compilationOptions)}catch(d){const s=new _core_Error_js__WEBPACK_IMPORTED_MODULE_0__["default"]("featurelayer","Failed to compile arcade expression",{error:d,expression:e.expression});return a().error(s),null}if(e.normalizationType||e.normalizationField)return new _NormalizedField_js__WEBPACK_IMPORTED_MODULE_7__.NormalizedField(e.field,e);if(e.field)return new _CachedField_js__WEBPACK_IMPORTED_MODULE_4__.CachedField(e.field);const i=new _core_Error_js__WEBPACK_IMPORTED_MODULE_0__["default"]("featurelayer","Unable to create computed field. No expression or field found",{info:e});return a().error(i),null}async createWhereClause(t){return t?(0,_whereUtils_js__WEBPACK_IMPORTED_MODULE_9__.createWhereClause)(t,this.compilationOptions.fields):null}getBitset(t){return this._bitsets[t-1]}getComputedNumeric(t,e){return this.getComputedNumericAtIndex(t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask,0)}setComputedNumeric(t,e,s){return this.setComputedNumericAtIndex(t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask,s,0)}getComputedString(t,e){return this.getComputedStringAtIndex(t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask,0)}setComputedString(t,e,s){return this.setComputedStringAtIndex(t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask,0,s)}getComputedNumericAtIndex(t,e){const s=t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask;return this._ensureNumeric(e,s),this._numerics[e][s]}setComputedNumericAtIndex(t,e,s){const r=t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask;this._ensureNumeric(e,r),this._numerics[e][r]=s}getPackedChunkId(t){const e=t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask;return this._ensureInstanceId(e),this._instanceIds[e]}setPackedChunkId(t,e){const s=t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask;this._ensureInstanceId(s),this._instanceIds[s]=e}getComputedStringAtIndex(t,e){const s=t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask;return this._ensureString(e,s),this._strings[e][s]}setComputedStringAtIndex(t,e,s){const r=t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask;this._ensureString(e,r),this._strings[e][r]=s}getXMin(t){return this._bounds[4*(t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask)]}getYMin(t){return this._bounds[4*(t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask)+1]}getXMax(t){return this._bounds[4*(t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask)+2]}getYMax(t){return this._bounds[4*(t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask)+3]}setBounds(t,e,s=!1){const r=t&_engine_webgl_DisplayId_js__WEBPACK_IMPORTED_MODULE_3__.displayIdTexelMask;if(!s&&!this._dirtyBitset.has(t))return this._bounds[4*r]!==c;this._dirtyBitset.unset(t);const n=e.readGeometryWorldSpace();if(m(this._bounds,4*r+4,0),!n||!n.coords.length)return this._bounds[4*r]=c,this._bounds[4*r+1]=c,this._bounds[4*r+2]=c,this._bounds[4*r+3]=c,!1;let o=1/0,u=1/0,d=-1/0,h=-1/0;return n.forEachVertex(((t,e)=>{o=Math.min(o,t),u=Math.min(u,e),d=Math.max(d,t),h=Math.max(h,e)})),this._bounds[4*r]=o,this._bounds[4*r+1]=u,this._bounds[4*r+2]=d,this._bounds[4*r+3]=h,!0}getBounds(t,e){const i=this.getXMin(e),r=this.getYMin(e),n=this.getXMax(e),o=this.getYMax(e);return (0,_geometry_support_aaBoundingBox_js__WEBPACK_IMPORTED_MODULE_2__.fromRectValues)(t,i,r,n,o),i!==c}_ensureNumeric(t,e){this._numerics[t]||(this._numerics[t]=[]);m(this._numerics[t],e,0)}_ensureInstanceId(t){m(this._instanceIds,t,0)}_ensureString(t,e){this._strings[t]||(this._strings[t]=[]);m(this._strings[t],e,null)}}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ComputedExpression: function() { return /* binding */ c; }
/* harmony export */ });
/* harmony import */ var _core_string_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../core/string.js */ "./node_modules/@arcgis/core/core/string.js");
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
class c extends _AComputedField_js__WEBPACK_IMPORTED_MODULE_3__.AComputedField{static async create(t,s){const a=await (0,_support_arcadeOnDemand_js__WEBPACK_IMPORTED_MODULE_1__.createRendererExpression)(t,s.spatialReference,s.fields),i=(0,_core_string_js__WEBPACK_IMPORTED_MODULE_0__.numericHash)(t);return new c(a,i)}constructor(e,r){super(),this._compiled=e,this._cacheKey=r}resize(e){}read(e,r){return this.referencesScale()||"system"!==r.$view.timeZone?(0,_arcade_callExpressionWithCursor_js__WEBPACK_IMPORTED_MODULE_2__.callExpressionWithCursor)(this._compiled,e,r):this._readCached(e,r)}readWithDefault(e,r,t){return this.referencesScale()||"system"!==r.$view.timeZone?(0,_arcade_callExpressionWithCursor_js__WEBPACK_IMPORTED_MODULE_2__.callExpressionWithCursorWithDefault)(this._compiled,e,r,t):this._readWithDefaultCached(e,r,t)}referencesScale(){return this._compiled?.referencesScale()??!1}referencesGeometry(){return this._compiled?.referencesGeometry()??!1}_readCached(e,r){if(e.setCache(this._cacheKey),e.hasCachedValue())return e.getCachedValue();const s=(0,_arcade_callExpressionWithCursor_js__WEBPACK_IMPORTED_MODULE_2__.callExpressionWithCursor)(this._compiled,e,r);return e.setCachedValue(s),s}_readWithDefaultCached(e,r,t){if(e.setCache(this._cacheKey),e.hasCachedValue())return e.getCachedValue();const a=(0,_arcade_callExpressionWithCursor_js__WEBPACK_IMPORTED_MODULE_2__.callExpressionWithCursorWithDefault)(this._compiled,e,r,t);return e.setCachedValue(a),a}}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   ComputedLegacyLabelExpression: function() { return /* binding */ a; }
/* harmony export */ });
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
class a extends _AComputedField_js__WEBPACK_IMPORTED_MODULE_3__.AComputedField{static async create(t,s){const l=(0,_layers_support_labelUtils_js__WEBPACK_IMPORTED_MODULE_1__.sqlToTemplateString)(t);return new a((r=>l.replaceAll(/{[^}]*}/g,(t=>{const s=t.slice(1,-1),a=r.metadata.fieldsIndex.get(s);if(null==a)return t;const l=r.readAttribute(s);return null==l?"":(0,_layers_support_labelFormatUtils_js__WEBPACK_IMPORTED_MODULE_0__.formatField)(l,a)}))))}constructor(e){super(),this._evaluator=e}resize(e){}read(e,r){return this._evaluator(e)}readWithDefault(e,r,s){const a=this._evaluator(e);return (0,_arcade_callExpressionWithCursor_js__WEBPACK_IMPORTED_MODULE_2__.isBadArcadeResult)(a)?s:a}referencesScale(){return!1}referencesGeometry(){return!1}}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DisplayIdGenerator: function() { return /* binding */ s; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FeatureMetadata: function() { return /* binding */ i; },
/* harmony export */   GraphicsMetadata: function() { return /* binding */ n; }
/* harmony export */ });
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
class i{static minimal(e,n,l=[]){return new i({geometryType:e,fieldsIndex:new _layers_support_FieldsIndex_js__WEBPACK_IMPORTED_MODULE_1__["default"](l).toJSON(),objectIdField:n,subtypes:null,subtypeField:null,types:null,globalIdField:null,spatialReference:null,timeInfo:null,timeReferenceUnknownClient:null,typeIdField:null})}static createFeature(e){return new i(e)}constructor(i){this._options=i,this._fieldsIndex=_layers_support_FieldsIndex_js__WEBPACK_IMPORTED_MODULE_1__["default"].fromJSON(i.fieldsIndex),i.spatialReference&&(this._spatialReference=_geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_0__["default"].fromJSON(i.spatialReference)),this._arcadeSchema={fields:this.fieldsIndex.fields,fieldsIndex:this.fieldsIndex,geometryType:this.geometryType,objectIdField:this.objectIdField,globalIdField:this._options.globalIdField,spatialReference:this._spatialReference,timeInfo:this._options.timeInfo,typeIdField:this._options.typeIdField??void 0,types:this._options.types??void 0,subtypeField:this._options.subtypeField,subtypes:this._options.subtypes??void 0}}get fieldsIndex(){return this._fieldsIndex}get geometryType(){return"esriGeometryMultiPatch"===this._options.geometryType?"esriGeometryPolygon":this._options.geometryType}get serviceGeometryType(){return this._options.geometryType}get subtypeField(){return this._options.subtypeField}get timeInfo(){return this._options.timeInfo}get objectIdField(){return this._options.objectIdField}get globalIdField(){return this._options.globalIdField}get arcadeSchema(){return this._arcadeSchema}get spatialReference(){return this._spatialReference}get timeReferenceUnknownClient(){return this._options.timeReferenceUnknownClient}}class n extends i{static createGraphics(e){return new n({fieldsIndex:(new _layers_support_FieldsIndex_js__WEBPACK_IMPORTED_MODULE_1__["default"]).toJSON(),objectIdField:"uid",geometryType:null,spatialReference:e,globalIdField:null,subtypeField:null,subtypes:null,timeInfo:null,typeIdField:null,types:null,timeReferenceUnknownClient:null})}}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FeatureSetCache: function() { return /* binding */ a; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   FeatureSetReader: function() { return /* binding */ M; }
/* harmony export */ });
...
/* harmony import */ var _geometry_support_labelPoint_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../../../geometry/support/labelPoint.js */ "./node_modules/@arcgis/core/geometry/support/labelPoint.js");
...
/* harmony import */ var _StaticBitSet_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./StaticBitSet.js */ "./node_modules/@arcgis/core/views/2d/layers/features/support/StaticBitSet.js");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   NormalizedField: function() { return /* binding */ r; }
/* harmony export */ });
/* harmony import */ var _AComputedField_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./AComputedField.js */ "./node_modules/@arcgis/core/views/2d/layers/features/support/AComputedField.js");
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   StaticBitSet: function() { return /* binding */ t; }
/* harmony export */ });
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createWhereClause: function() { return /* binding */ o; }
/* harmony export */ });
/* harmony import */ var _core_Error_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../core/Error.js */ "./node_modules/@arcgis/core/core/Error.js");
/* harmony import */ var _core_Logger_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../../../core/Logger.js */ "./node_modules/@arcgis/core/core/Logger.js");
/* harmony import */ var _core_sql_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../core/sql.js */ "./node_modules/@arcgis/core/core/sql.js");
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
const a=()=>_core_Logger_js__WEBPACK_IMPORTED_MODULE_1__["default"].getLogger("esri.views.2d.layers.features.support.whereUtils"),n={getAttribute:(e,r)=>e.readAttribute(r)};async function o(r,o){try{const s=await (0,_core_sql_js__WEBPACK_IMPORTED_MODULE_2__.parseWhereClause)(r,o);if(!s.isStandardized){const r=new _core_Error_js__WEBPACK_IMPORTED_MODULE_0__["default"]("mapview - bad input","Unable to apply filter's definition expression, as expression is not standardized.",s);a().error(r)}return e=>{const t=e.readArcadeFeature();try{return s.testFeature(t,n)}catch(o){return a().warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",r),!0}}}catch(s){return a().warn("mapview-bad-where-clause","Encountered an error when evaluating where clause",r),e=>!0}}


/***/ })

}]);
//# sourceMappingURL=vendors-node_modules_arcgis_core_views_2d_engine_webgl_mesh_MeshData_js-node_modules_arcgis_c-01a17c.0f6b705b07c25aae7e4d.js.map