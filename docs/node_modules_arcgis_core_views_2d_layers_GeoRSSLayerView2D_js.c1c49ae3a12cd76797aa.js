"use strict";
(self["webpackChunkreact_redux_arcgis_boilerplate"] = self["webpackChunkreact_redux_arcgis_boilerplate"] || []).push([["node_modules_arcgis_core_views_2d_layers_GeoRSSLayerView2D_js"],{
...
/* harmony export */   GraphicInstanceStore: function() { return /* binding */ o; }
/* harmony export */ });
...
*/
let n=0;function a(i,a){return new _TechniqueInstance_js__WEBPACK_IMPORTED_MODULE_0__.FeatureTechniqueInstance((0,_mesh_instanceIdUtils_js__WEBPACK_IMPORTED_MODULE_2__.castInstanceId)(n++),i,a)}const l={visualVariableColor:null,visualVariableOpacity:null,visualVariableSizeMinMaxValue:null,visualVariableSizeScaleStops:null,visualVariableSizeStops:null,visualVariableSizeUnitValue:null,visualVariableRotation:null,visualVariableSizeOutlineScaleStops:null};class o{constructor(){this.instances={fill:a(_TechniqueRegistry_js__WEBPACK_IMPORTED_MODULE_1__.Techniques.fill,{uniforms:l,optionalAttributes:{zoomRange:!0}}),marker:a(_TechniqueRegistry_js__WEBPACK_IMPORTED_MODULE_1__.Techniques.marker,{uniforms:l,optionalAttributes:{zoomRange:!0}}),line:a(_TechniqueRegistry_js__WEBPACK_IMPORTED_MODULE_1__.Techniques.line,{uniforms:l,optionalAttributes:{zoomRange:!0}}),text:a(_TechniqueRegistry_js__WEBPACK_IMPORTED_MODULE_1__.Techniques.text,{uniforms:l,optionalAttributes:{zoomRange:!0,referenceSymbol:!1,clipAngle:!1}}),complexFill:a(_TechniqueRegistry_js__WEBPACK_IMPORTED_MODULE_1__.Techniques.complexFill,{uniforms:l,optionalAttributes:{zoomRange:!0}}),texturedLine:a(_TechniqueRegistry_js__WEBPACK_IMPORTED_MODULE_1__.Techniques.texturedLine,{uniforms:l,optionalAttributes:{zoomRange:!0}}),animatedMarker:a(_TechniqueRegistry_js__WEBPACK_IMPORTED_MODULE_1__.Techniques.animatedMarker,{uniforms:l,optionalAttributes:{zoomRange:!0}})},this._instancesById=Object.values(this.instances).reduce(((e,i)=>(e.set(i.instanceId,i),e)),new Map)}getInstance(e){return this._instancesById.get(e)}}
...
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
let y=class extends((0,_LayerView2D_js__WEBPACK_IMPORTED_MODULE_12__.LayerView2DMixin)(_layers_LayerView_js__WEBPACK_IMPORTED_MODULE_15__["default"])){constructor(){super(...arguments),this._graphicsViewMap={},this._popupTemplates=new Map,this.graphicsViews=[]}async hitTest(e,r){if(!this.graphicsViews.length)return null;const s=this.layer;return this.graphicsViews.reverse().flatMap((r=>{const i=this._popupTemplates.get(r),t=r.hitTest(e);for(const e of t)e.layer=s,e.sourceLayer=s,e.popupTemplate=i;return t})).map((r=>({type:"graphic",graphic:r,layer:s,mapPoint:e})))}update(e){if(this.graphicsViews)for(const r of this.graphicsViews)r.processUpdate(e)}attach(){this.addAttachHandles([(0,_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_3__.watch)((()=>this.layer?.featureCollections),(e=>{this._clear();for(const{popupInfo:i,featureSet:t,layerDefinition:o}of e){const e=_rest_support_FeatureSet_js__WEBPACK_IMPORTED_MODULE_11__["default"].fromJSON(t),p=new _core_Collection_js__WEBPACK_IMPORTED_MODULE_2__["default"](e.features),n=o.drawingInfo,m=i?_PopupTemplate_js__WEBPACK_IMPORTED_MODULE_1__["default"].fromJSON(i):null,y=(0,_renderers_support_jsonUtils_js__WEBPACK_IMPORTED_MODULE_10__.fromJSON)(n.renderer),g=new _graphics_GraphicsView2D_js__WEBPACK_IMPORTED_MODULE_14__["default"]({requestUpdateCallback:()=>this.requestUpdate(),view:this.view,graphics:p,renderer:y,container:new _graphics_GraphicContainer_js__WEBPACK_IMPORTED_MODULE_13__["default"](this.view.featuresTilingScheme)});this._graphicsViewMap[e.geometryType]=g,this._popupTemplates.set(g,m),"polygon"!==e.geometryType||this.layer.polygonSymbol?"polyline"!==e.geometryType||this.layer.lineSymbol?"point"!==e.geometryType||this.layer.pointSymbol||(this.layer.pointSymbol=y.symbol):this.layer.lineSymbol=y.symbol:this.layer.polygonSymbol=y.symbol,this.graphicsViews.push(g),this.container.addChild(g.container)}}),_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_3__.initial),(0,_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_3__.watch)((()=>this.layer?.polygonSymbol),(e=>{this._graphicsViewMap.polygon.renderer=new _renderers_SimpleRenderer_js__WEBPACK_IMPORTED_MODULE_9__["default"]({symbol:e})}),_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_3__.initial),(0,_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_3__.watch)((()=>this.layer?.lineSymbol),(e=>{this._graphicsViewMap.polyline.renderer=new _renderers_SimpleRenderer_js__WEBPACK_IMPORTED_MODULE_9__["default"]({symbol:e})}),_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_3__.initial),(0,_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_3__.watch)((()=>this.layer?.pointSymbol),(e=>{this._graphicsViewMap.point.renderer=new _renderers_SimpleRenderer_js__WEBPACK_IMPORTED_MODULE_9__["default"]({symbol:e})}),_core_reactiveUtils_js__WEBPACK_IMPORTED_MODULE_3__.initial)])}detach(){this._clear()}moveEnd(){}viewChange(){for(const e of this.graphicsViews)e.viewChange()}_clear(){this.container.removeAllChildren();for(const e of this.graphicsViews)e.destroy();this._graphicsViewMap={},this._popupTemplates.clear(),this.graphicsViews.length=0}};y=(0,_chunks_tslib_es6_js__WEBPACK_IMPORTED_MODULE_0__._)([(0,_core_accessorSupport_decorators_subclass_js__WEBPACK_IMPORTED_MODULE_8__.subclass)("esri.views.2d.layers.GeoRSSLayerView2D")],y);const g=y;
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   AGraphicContainer: function() { return /* binding */ i; }
/* harmony export */ });
...
/* harmony import */ var _AGraphicContainer_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AGraphicContainer.js */ "./node_modules/@arcgis/core/views/2d/layers/graphics/AGraphicContainer.js");
/* harmony import */ var _support_util_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../support/util.js */ "./node_modules/@arcgis/core/views/2d/layers/support/util.js");
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.31/esri/copyright.txt for details.
*/
class t extends _AGraphicContainer_js__WEBPACK_IMPORTED_MODULE_1__.AGraphicContainer{renderChildren(i){for(const e of this.children)e.setTransform(i.state);if(super.renderChildren(i),this._updateAttributeView(),this.children.some((e=>e.hasData))){switch(i.drawPhase){case _engine_webgl_enums_js__WEBPACK_IMPORTED_MODULE_0__.WGLDrawPhase.MAP:this._renderChildren(i,_engine_webgl_enums_js__WEBPACK_IMPORTED_MODULE_0__.FeatureSelection.All);break;case _engine_webgl_enums_js__WEBPACK_IMPORTED_MODULE_0__.WGLDrawPhase.HIGHLIGHT:this.hasHighlight&&this._renderHighlight(i)}this._boundsRenderer&&this._boundsRenderer.doRender(i)}}_renderHighlight(e){(0,_support_util_js__WEBPACK_IMPORTED_MODULE_2__.renderHighlight)(e,!1,(e=>{this._renderChildren(e,_engine_webgl_enums_js__WEBPACK_IMPORTED_MODULE_0__.FeatureSelection.Highlight)}))}}


/***/ })

}]);
//# sourceMappingURL=node_modules_arcgis_core_views_2d_layers_GeoRSSLayerView2D_js.c1c49ae3a12cd76797aa.js.map